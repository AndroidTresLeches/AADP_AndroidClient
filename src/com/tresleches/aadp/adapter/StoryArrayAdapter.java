...
public class StoryArrayAdapter extends ArrayAdapter<Story> {
	...
	public View getView(int position, View view, ViewGroup parent) {
		...
		if (view == null) {
			...
			viewHolder.ivStoryImage = (ImageView) view
					.findViewById(R.id.ivStoryImage);
			viewHolder.tvStoryName = (TextView) view
					.findViewById(R.id.tvStoryName);
			viewHolder.tvStoryDetail = (TextView) view
					.findViewById(R.id.tvStoryDetail);
